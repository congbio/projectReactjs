            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="single-footer-widget instafeed">
                ...
                <ul className="list_style instafeed d-flex flex-wrap">
                  <li><img src="./image/Image-01.jpg" alt="" /></li>
                  <img src=''></img>
                  <li><img src="./image/Image-02.jpg" alt=" " /></li>
                  <li><img src="./image/Image-03.jpg" alt="" /></li>
                  <li><img src="./image/Image-04.jpg" alt="" /></li>
                  <li><img src="./image/Image-05.jpg" alt="" /></li>
                  <li><img src="./image/Image-06.jpg" alt="" /></li>
                  <li><img src="./image/Image-07.jpg" alt="" /></li>
                  <li><img src="./image/Image-08.jpg" alt="" /></li>
                </ul>
              </div>
            </div>						
          </div>
